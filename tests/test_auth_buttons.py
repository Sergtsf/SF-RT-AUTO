...
# Работа кнопки "Почта" которая открывает форму входа с помощью электронной почты
...
# Работа кнопки "Зарегистрироваться" которая открывает форму "Регистрация"
...
# Работа кнопки "Забыл пароль" которая открывает форму "Восстановление пароля"
...
# Работа кнопки "Вернуться назад" в форме "Восстановление пароля" которая открывает форму "Авторизация"
